...
###############################################################################
host       = "13.127.178.106"       # Ip address of server
#host = "192.168.1.169"
#host       = socket.gethostbyname(socket.gethostname())
port       = 6001                  # tcp port of server

delay      = 5                     # This is for testing purposes
pinlist    = [2,3,4,5,6,7,8,9]     # Add your relay Pins BCM
folderDir  = "/home/pi/Desktop/SwitchControl/bin/"#os.getcwd()           # get Current folder directory for Bin
###############################################################################
...
b1_on  = PhotoImage(file = folderDir + 'button1_on.gif')
b2_on  = PhotoImage(file = folderDir + 'button2_on.gif')
b3_on  = PhotoImage(file = folderDir + 'button3_on.gif')
b4_on  = PhotoImage(file = folderDir + 'button4_on.gif')
b5_on  = PhotoImage(file = folderDir + 'button5_on.gif')
b6_on  = PhotoImage(file = folderDir + 'button6_on.gif')
b7_on  = PhotoImage(file = folderDir + 'button7_on.gif')
b8_on  = PhotoImage(file = folderDir + 'button8_on.gif')

b1_off = PhotoImage(file =  folderDir + 'button1_off.gif')
b2_off = PhotoImage(file =  folderDir + 'button2_off.gif')
b3_off = PhotoImage(file =  folderDir + 'button3_off.gif')
b4_off = PhotoImage(file =  folderDir + 'button4_off.gif')
b5_off = PhotoImage(file =  folderDir + 'button5_off.gif')
b6_off = PhotoImage(file =  folderDir + 'button6_off.gif')
b7_off = PhotoImage(file =  folderDir + 'button7_off.gif')
b8_off = PhotoImage(file =  folderDir + 'button8_off.gif')
